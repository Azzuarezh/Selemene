 ...
 */
app
.directive('leftDirective',['$timeout',function($timeout){
	return {
        restrict: 'E',
        templateUrl : 'template/panel/left.tpl.html',
        transclude : true,
...
.directive('listTable',function($parse){
	return{
		restrict :'E',	
		templateUrl : 'template/panel/dbo/table.tpl.html',
		scope :{
			dbName : '@db'
		}
	}
...
.directive('listView',function($parse){
	return{
		restrict :'E',	
		templateUrl : 'template/panel/dbo/view.tpl.html',
		scope :{
			dbName : '@db'
		}
	}
